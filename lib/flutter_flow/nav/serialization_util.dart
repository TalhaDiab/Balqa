      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case BookingsDuplicateRow:
            return BookingsDuplicateRow(data);
          case BranchesRow:
            return BranchesRow(data);
          case DiscountRow:
            return DiscountRow(data);
          case DiscountCodesRow:
            return DiscountCodesRow(data);
          case DiscountUsageRow:
            return DiscountUsageRow(data);
          case DriverLiveLocationRow:
            return DriverLiveLocationRow(data);
          case DriverLocationHistoryRow:
            return DriverLocationHistoryRow(data);
          case DriversRow:
