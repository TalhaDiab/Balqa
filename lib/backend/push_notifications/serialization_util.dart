...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case BookingsRow:
        return BookingsRow(json.decode(param) as Map<String, dynamic>) as T;
      case BookingsDuplicateRow:
        return BookingsDuplicateRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case BranchesRow:
        return BranchesRow(json.decode(param) as Map<String, dynamic>) as T;
      case DiscountRow:
        return DiscountRow(json.decode(param) as Map<String, dynamic>) as T;
      case DiscountCodesRow:
        return DiscountCodesRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case DiscountUsageRow:
        return DiscountUsageRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case DriverLiveLocationRow:
        return DriverLiveLocationRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case DriverLocationHistoryRow:
        return DriverLocationHistoryRow(
            json.decode(param) as Map<String, dynamic>) as T;
      case DriversRow:
        return DriversRow(json.decode(param) as Map<String, dynamic>) as T;
      case GovernoratesRow:
        return GovernoratesRow(json.decode(param) as Map<String, dynamic>) as T;
      case NotesRow:
        return NotesRow(json.decode(param) as Map<String, dynamic>) as T;
      ...
      case ShipmentTrackingRow:
        return ShipmentTrackingRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case ShippingRow:
        return ShippingRow(json.decode(param) as Map<String, dynamic>) as T;
      case TripsRow:
        return TripsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UsersRow:
