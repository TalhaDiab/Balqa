  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<AppRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AppRow> termsAppRowList = snapshot.data!;

        final termsAppRow =
            termsAppRowList.isNotEmpty ? termsAppRowList.first : null;
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getVariableText(
                              arText: termsAppRow?.terms,
                              enText: termsAppRow?.termsEN,
                            ),
